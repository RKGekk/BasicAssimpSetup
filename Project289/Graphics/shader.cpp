...
bool VertexShader::Initialize(Microsoft::WRL::ComPtr<ID3D11Device>& device, const ShaderGonfig& cfg) {
...
bool PixelShader::Initialize(Microsoft::WRL::ComPtr<ID3D11Device>& device, const ShaderGonfig& cfg) {
	HRESULT hr = D3DReadFileToBlob(
		cfg.shader_name.c_str(),
		m_shader_buffer.GetAddressOf()
	);
